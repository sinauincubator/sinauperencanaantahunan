		...
		<div class="col-md-12">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body form" style="">
					<!-- BEGIN FORM-->
					<form
						action="http://203.130.231.101:8998/musrenbang/kecamatan/cari"
									...
									<div class="row">
										<div class="col-md-offset-1 col-md-12">
											<button type="submit" class="btn green">
												<i class="fa fa-check"></i> Cari Hasil Musrenbang
											</button>
											<a href="http://203.130.231.101:8998/musrenbang/kecamatan"
											...
											<div class="btn-group" style="margin-left: 100px;">
												<button type="button" class="btn blue dropdown-toggle"
													...
													<i class="fa fa-plus"></i> Tambah Hasil Musrenbang
												</button>
												<button type="button" class="btn blue dropdown-toggle"
													data-toggle="dropdown">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="musrembangkecamatanaddbelanjalangsung.htm">Belanja
															Langsung</a></li>
													<li><a
														href="musrembangkecamatanaddbelanjatidaklangsung.htm">Belanja
															Tidak Langsung</a></li>
												</ul>
											</div>
										</div>
