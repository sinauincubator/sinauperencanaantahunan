				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-search"></i>Pencarian Hasil Musrenbang Kelurahan
										</div>
										<div class="tools">
									...
									<div class="portlet-body form" style="">
										<!-- BEGIN FORM-->
										<form action="http://203.130.231.101:8998/musrenbang/kelurahan/cari" class="form-horizontal" method="post">
											<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group" id="tampil_combobox_deskel_by_kecamatan">
															<label class="control-label col-md-3" for="deskel_kode">Kelurahan</label>
															<div class="col-md-9">
													...
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-offset-1 col-md-12">
																...
																<a href="http://203.130.231.101:8998/musrenbang/kelurahan" class="btn default"> <i class="fa fa-times"></i> Bersihkan Hasil Pencarian</a>
																																<a style="margin-left:100px;" href="http://203.130.231.101:8998/musrenbang/kelurahan/sync" class="btn default"> <i class="fa fa-refresh"></i> Sinkronisasi</a>
																															</div>
														</div>
													</div>
													<div class="col-md-6">
