		...
		<div class="col-md-12">
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-search"></i>Pencarian Hasil Rencana Kerja
						Perubahan
					</div>
					<div class="tools">
						<a href="javascript:;" class="collapse"
							data-original-title="From Pencarian" title="From Pencarian"></a>
					</div>
				</div>
				<div class="portlet-body form" style="">
					<!-- BEGIN FORM-->
					<form
						action="http://203.130.231.101:8998/rencana-kerja/perubahan/cari"
						...
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">Tahun <span
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3" for="kegiatan">Nama
											Kegiatan</label>
										<div class="col-md-9">
									...
									<div class="form-group">
										...
										<div class="radio-list">
											<label class="radio-inline"> <input type="radio"
												name="tipe_kode" id="tipe_kode" value="1" checked>
												Belanja Langsung
											</label> <label class="radio-inline"> <input type="radio"
												name="tipe_kode" id="tipe_kode" value="2"> Belanja
												Tidak Langsung
											</label>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-offset-1 col-md-12">
											<button type="submit" class="btn green">
												<i class="fa fa-check"></i> Cari Hasil Rencana Kerja
												Perubahan
											</button>
											<a href="http://203.130.231.101:8998/rencana-kerja/perubahan"
												class="btn default"> <i class="fa fa-times"></i>
												Bersihkan Hasil Pencarian
											</a>
											<!--
																<div class="btn-group" style="margin-left:100px;">
																	<button type="button" class="btn blue dropdown-toggle" data-toggle="dropdown"><i class="fa fa-plus"></i> Tambah Hasil Rencana Kerja Perubahan</button>
																	<button type="button" class="btn blue dropdown-toggle" data-toggle="dropdown"><i class="fa fa-angle-down"></i></button>
																	<ul class="dropdown-menu" role="menu">
																	<li>
																		<a href="http://203.130.231.101:8998/rencana-kerja/perubahan/belanja-langsung">Belanja Langsung</a>
																	</li>
																	<li>
																		<a href="http://203.130.231.101:8998/rencana-kerja/perubahan/belanja-tidak-langsung">Belanja Tidak Langsung</a>
																	</li>
																	</ul>
																</div>
																-->
