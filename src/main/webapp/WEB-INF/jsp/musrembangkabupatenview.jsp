...
<head>
    ...
    <title>INTEGRASI | Kab Bekasi</title>
            ...
            <div class="panel panel-success">
				<div class="panel-heading"><i class="fa fa-search"></i> Pencarian Musrenbang Kabupaten</div>
				<div class="panel-body">
				<form action="http://203.130.231.101:8998/musrenbang/kabupaten/cari" class="form-horizontal" method="post">
					...
					<div style="margin-left:500px;">
						<div class="col-md-12">
							<div class="col-md-offset-1 col-md-12">
								...
								<a href="http://203.130.231.101:8998/musrenbang/kabupaten" id="confirmasiHapus" class="btn btn-default"><i class="fa fa-eraser"></i> Clear</a>							</div>
						</div>
					</div>
					<!--/row-->							
					</form>
